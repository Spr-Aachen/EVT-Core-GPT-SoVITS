...
def init_bigvgan():
    ...
    bigvgan_model = bigvgan.BigVGAN.from_pretrained(bigvgan_path, use_cuda_kernel=False)  # if True, RuntimeError: Ninja is required to load C++ extensions
...
if __name__ == '__main__':
    ...
    asyncio.run(
        convert(
            ...
            'd:/Projekt/Git/Python Projects/EVT - test/Models/TTS/GPT-SoVITS/Downloaded/nvidia--bigvgan',
            refer_wav_path = 'D:/15.wav',
            prompt_text = "是，拉斯提摩沙上尉给了你代理铁御的暂时军职，恭喜你，你可以叫我BT。",
            prompt_language='auto',
            stream_mode='close',
            text='你好',
            text_language='auto',
            output_path = 'd:/temp.wav'
        )
    )