...
name2sovits_path = {
    # "不训练直接推v1底模！": "GPT_SoVITS/pretrained_models/s2G488k.pth",
    "不训练直接推v2底模！": "GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth",
    # "不训练直接推v3底模！": "GPT_SoVITS/pretrained_models/s2Gv3.pth",
    # "不训练直接推v4底模！": "GPT_SoVITS/pretrained_models/gsv-v4-pretrained/s2Gv4.pth",
...
name2gpt_path = {
    # "不训练直接推v1底模！"):"GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt",
