...
path_sovits_v3 = os.environ.get("sovits_v3_path", "GPT_SoVITS/pretrained_models/s2Gv3.pth")
...
from module.models import SynthesizerTrn, SynthesizerTrnV3 # Edit: remove 'GPT_SoVITS.'
