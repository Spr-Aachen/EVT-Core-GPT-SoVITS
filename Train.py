...
def open1Ba(
    ...
    if(p_train_SoVITS==None):
        ...
        print("SoVITS训练开始：%s"%cmd) #yield process_info(process_name_sovits, "opened"), {"__type__": "update", "visible": False}, {"__type__": "update", "visible": True}
        print(cmd)
        p_train_SoVITS = Popen(cmd, shell=True)
        p_train_SoVITS.wait()
        p_train_SoVITS=None
        print("SoVITS训练完成") #yield process_info(process_name_sovits, "finish"), {"__type__": "update", "visible": True}, {"__type__": "update", "visible": False}
    else:
        print("已有正在进行的SoVITS训练任务，需先终止才能开启下一次任务") #yield process_info(process_name_sovits, "occupy"), {"__type__": "update", "visible": False}, {"__type__": "update", "visible": True}
...
def open1Bb(
    ...
    if(p_train_GPT==None):
        ...
        print("GPT训练开始：%s"%cmd) #yield process_info(process_name_gpt, "opened"), {"__type__": "update", "visible": False}, {"__type__": "update", "visible": True}
        print(cmd)
        p_train_GPT = Popen(cmd, shell=True)
        p_train_GPT.wait()
        p_train_GPT = None
        print("GPT训练完成") #yield process_info(process_name_gpt, "finish"), {"__type__": "update", "visible": True}, {"__type__": "update", "visible": False}
    else:
        print("已有正在进行的GPT训练任务，需先终止才能开启下一次任务") #yield process_info(process_name_gpt, "occupy"), {"__type__": "update", "visible": False}, {"__type__": "update", "visible": True}
